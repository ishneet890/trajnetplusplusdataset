...
def main():
    ...
    # Synthetic datasets conversion
        ...
        write(controlled(sc, 'data/raw/controlled/orca_circle_crossing_9ped_1000scenes_.txt'),
              'output_pre/{split}/orca_five_synth.ndjson', args)
        categorize(sc, 'output_pre/{split}/orca_five_synth.ndjson', args)
        edit_goal_file('orca_circle_crossing_9ped_1000scenes_.pkl', 'orca_five_synth.pkl')
